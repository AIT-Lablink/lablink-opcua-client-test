...
SET OPCUA_CLIENT_JAR_FILE=%SETUP_ROOT_DIR%\target\dependency\opcuaclient-0.0.2-jar-with-dependencies.jar

REM Path to Java JAR file of CSV client.
SET CSV_CLIENT_JAR_FILE=%SETUP_ROOT_DIR%\target\dependency\csvclient-0.0.1-jar-with-dependencies.jar

REM Path to Java JAR file of data plotter.
SET PLOT_JAR_FILE=%SETUP_ROOT_DIR%\target\dependency\plotter-0.0.2-jar-with-dependencies.jar

REM Path to Java JAR file of data point bridge.
SET DPB_JAR_FILE=%SETUP_ROOT_DIR%\target\dependency\dpbridge-0.0.1-jar-with-dependencies.jar

REM Path to Java JAR file of config server.
SET CONFIG_JAR_FILE=%SETUP_ROOT_DIR%\target\dependency\config-0.1.0-jar-with-dependencies.jar
